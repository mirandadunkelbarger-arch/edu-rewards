...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex font-sans text-slate-900">
      ...
      <main className="flex-1 p-6 md:p-12 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            {selectedStudent ? (
              <div className="bg-white p-10 rounded-[3rem] shadow-2xl border border-slate-50 sticky top-10">
      ...
      {/* Toast */}
      {toast && (
        <div className="fixed bottom-12 left-1/2 -translate-x-1/2 bg-slate-900 text-white px-8 py-5 rounded-full shadow-2xl flex items-center gap-4 z-[150]">
